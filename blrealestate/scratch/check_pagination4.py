...
print("PAGE 2 WITH CATEGORY COMMERCIAL:")
p2 = req('/ChannelPartner/properties?page=2&per_page=20&category=Commercial')
print(f"Total: {p2.get('data', {}).get('total')}, Page: {p2.get('data', {}).get('current_page')}, Last: {p2.get('data', {}).get('last_page')}, Count: {len(p2.get('data', {}).get('data', []))}")
